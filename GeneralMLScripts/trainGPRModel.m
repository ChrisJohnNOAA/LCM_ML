function [trainedModel, validationRMSE] = trainGPRModel(trainingData, predictorNames, responseData, kernel, evaluations)
...
% Auto-generated by MATLAB on 10-Aug-2022 00:18:34
...
regressionGP = fitrgp(...
    ...
    'OptimizeHyperparameters',{'BasisFunction','Sigma'},'HyperparameterOptimizationOptions',...
    struct('AcquisitionFunctionName','expected-improvement-plus', ...
    'UseParallel', true, ...
    'MaxObjectiveEvaluations', evaluations));

    %'OptimizeHyperparameters',{'BasisFunction','KernelScale','Sigma'},'HyperparameterOptimizationOptions',...

    %'BasisFunction', 'constant', ...
    %'OptimizeHyperparameters',{'KernelFunction', 'KernelScale','Sigma'},'HyperparameterOptimizationOptions',...
...
regressionGP = compact(regressionGP);
